...
- extraction now handles **natural phrasings**, not only the `<field> is <value>` template
...
- **source_url**: https://github.com/automerchlab/runx/tree/8eae1e5dd49704c4c20b54a8f15fb4b94954366f
- **raw X.yaml**: https://raw.githubusercontent.com/automerchlab/runx/8eae1e5dd49704c4c20b54a8f15fb4b94954366f/skills/crm-cleanup/X.yaml
- **raw SKILL.md**: https://raw.githubusercontent.com/automerchlab/runx/8eae1e5dd49704c4c20b54a8f15fb4b94954366f/skills/crm-cleanup/SKILL.md
...
- source_url, raw X.yaml, raw SKILL.md and verification.json all resolve at one source revision:
  commit `8eae1e5dd49704c4c20b54a8f15fb4b94954366f` on the `automerchlab/runx` `crm-cleanup` branch.
- The skill files at `8eae1e5dd49704c4c20b54a8f15fb4b94954366f` are byte-identical to the published package `automerchlab/crm-cleanup@sha-44376c7817e7` (matching digest).
- This report and evidence.json are committed as the direct child of `8eae1e5dd49704c4c20b54a8f15fb4b94954366f` and describe that same
...
3. Raw X.yaml / SKILL.md / verification.json at source revision `8eae1e5dd49704c4c20b54a8f15fb4b94954366f`.
