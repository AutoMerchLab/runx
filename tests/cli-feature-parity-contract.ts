...
const surfaceDefinitions: readonly RuntimeSurfaceDefinition[] = [
  ...
  surface("sandbox", "runx-core/policy + runx-runtime", "schema-exact", "Declared and enforced sandbox metadata must remain distinct."),
  ...
  surface("adapter-cli-tool", "runx-runtime cli-tool adapter", "fixture-backed", "Process invocation, env, cwd, and sandbox metadata are parity-critical."),
